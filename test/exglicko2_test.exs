defmodule Exglicko2Test do
  ...
  test "updating two teams from a single match" do
    ...
    assert updated_team_one == [
      ...
      %Exglicko2.Player{rating: -0.10448679338664246, deviation: 0.5830044120491541, volatility: 0.059997601601461156},
      %Exglicko2.Player{rating: 0.30879262132575813, deviation: 1.444054347059935, volatility: 0.05999888823648048}
    ]
    assert updated_team_two == [
      %Exglicko2.Player{rating: -0.616975738293235, deviation: 0.20788908025514855, volatility: 0.05999748464208987},
      %Exglicko2.Player{rating: 0.10448679338664249, deviation: 0.5830044120491541, volatility: 0.059997601601461156},
      %Exglicko2.Player{rating: -0.30879262132575813, deviation: 1.444054347059935, volatility: 0.05999888823648048}
    ]
  end
end
